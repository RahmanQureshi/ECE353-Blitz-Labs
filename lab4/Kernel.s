...
_CheckVersion_P_Kernel_:
	...
	set	0x8173949f,r4		! myHashVal = -2123131745
	cmp	r3,r4
	be	_Label_127
	set	_CVMess1,r1
	call	_putString
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_989 = &processTable
	load	[r14+8],r1
	add	r1,4,r1
	store	r1,[r14+-44]
!   Move address of _temp_989 [i ] into _temp_990
!     make sure index expr is >= 0
	load	[r14+-1472],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1031 = 0		(4 bytes)
	mov	0,r1
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1032 = 9		(4 bytes)
	mov	9,r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_1031  (sizeInBytes=4)
	load	[r14+-44],r1
	store	r1,[r14+-52]
_Label_1027:
!   Perform the FOR-LOOP termination test
!   if i > _temp_1032 then goto _Label_1030		
	load	[r14+-52],r1
	load	[r14+-40],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1038 = _function_124_PrintObjectAddr
	set	_function_124_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1039 = &freeList
	load	[r14+8],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1065 = _function_124_PrintObjectAddr
	set	_function_124_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1066 = &freeList
	load	[r14+8],r1
...
!   Send message IsEmpty
	...
	add	r2,16,r2
	call	r2
!   if result==true then goto _Label_1082 else goto _Label_1083
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1083
	jmp	_Label_1082
...
!   if intIsZero (nextProcessPtr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1088 = nextProcessPtr + 12
	load	[r14+-44],r1
	add	r1,12,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_1088 = nextPid  (sizeInBytes=4)
	load	[r14+8],r1
	load	[r1+1312],r1
	load	[r14+-20],r2
	store	r1,[r2]
...
!   _temp_1103 = p + 20
	...
	add	r1,20,r1
	store	r1,[r14+-28]
!   Data Move: *_temp_1103 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1130 = 1048576		(4 bytes)
	set	1048576,r1
	store	r1,[r14+-24]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1131 = 1048876		(4 bytes)
	set	1048876,r1
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
...
!   if intIsZero (i) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1134 = *i  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-16]
!   if intIsZero (_temp_1134) then goto _Label_1133
	load	[r14+-16],r1
	cmp	r1,r0
	be	_Label_1133
!	jmp	_Label_1132
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1165:
!   if numberFreeFrames >= 1 then goto _Label_1167		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	mov	1,r2
	cmp	r1,r2
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1172 = f * 8192		(int)
	load	[r14+-36],r1
	mov	8192,r2
	mul	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-12]
!   frameAddr = 1048576 + _temp_1172		(int)
	set	1048576,r1
	load	[r14+-12],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1192:
!   if numberFreeFrames >= numFramesNeeded then goto _Label_1194		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	load	[r14+16],r2
	cmp	r1,r2
...
!   _temp_1201 = 0		(4 bytes)
	...
	store	r1,[r14+-28]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1202 = numFramesNeeded - 1		(int)
	load	[r14+16],r1
	mov	1,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (aPageTable) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1204 = aPageTable + 4
	load	[r14+12],r1
	add	r1,4,r1
	store	r1,[r14+-16]
!   Data Move: *_temp_1204 = numFramesNeeded  (sizeInBytes=4)
	load	[r14+16],r1
	load	[r14+-16],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_1229 = frameAddr - 1048576		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-36]
!   bitIndex = _temp_1229 div 8192		(int)
	load	[r14+-36],r1
	mov	8192,r2
	cmp	r2,0
