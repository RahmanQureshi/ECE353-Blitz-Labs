...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1180:
!   if numberFreeFrames >= 1 then goto _Label_1182		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	mov	1,r2
	cmp	r1,r2
...
!   Next value...
	...
	store	r1,[r14+-16]
_Label_1203:
!   Data Move: *_temp_1201 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_1201 = _temp_1201 + 4
...
!   _temp_1202 = _temp_1202 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_1202) then goto _Label_1203
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_1203
!   Initialize the array size...
...
!   make sure array has size 20
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_1199 = *_temp_1204  (sizeInBytes=84)
	load	[r14+-12],r5
	load	[r14+-108],r4
	mov	21,r3
_Label_1721:
...
!   _temp_1218 = 0		(4 bytes)
	...
	store	r1,[r14+-156]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1219 = numberOfPages - 1		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	1,r2
	sub	r1,r2,r1
...
!   Retrieve Result: targetName=_temp_1236  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-92]
!   if intIsZero (_temp_1236) then goto _Label_1235
	load	[r14+-92],r1
	cmp	r1,r0
	be	_Label_1235
!	jmp	_Label_1234
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1238  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-84]
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   if result==true then goto _Label_1264 else goto _Label_1265
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1265
	jmp	_Label_1264
...
!   Data Move: _temp_1313 = *_temp_1315  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1312 = _temp_1313 AND -8192		(int)
	load	[r14+-20],r1
	mov	-8192,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1312  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
!   Data Move: _temp_1324 = *_temp_1326  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1323 = _temp_1324 AND 8176		(int)
	load	[r14+-20],r1
	mov	8176,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1323  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1338 = *_temp_1340  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1337 = _temp_1338 AND 8191		(int)
	load	[r14+-20],r1
	mov	8191,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   _temp_1336 = _temp_1337 OR frameAddr		(int)
	load	[r14+-24],r1
	load	[r14+16],r2
	or	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1354 = *_temp_1356  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1353 = _temp_1354 AND 8		(int)
	load	[r14+-24],r1
	mov	8,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1369 = *_temp_1371  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1368 = _temp_1369 AND 4		(int)
	load	[r14+-24],r1
	mov	4,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1384 = *_temp_1386  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1383 = _temp_1384 AND 2		(int)
	load	[r14+-24],r1
	mov	2,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1383) then goto _Label_1387
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1387
!   _temp_1382 = 1		(1 byte)
...
!   _temp_1382 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1388:
!   ReturnResult: _temp_1382  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1399 = *_temp_1401  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1398 = _temp_1399 AND 1		(int)
	load	[r14+-24],r1
	mov	1,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1415 = *_temp_1417  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1414 = _temp_1415 OR 8		(int)
	load	[r14+-20],r1
	mov	8,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1430 = *_temp_1432  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1429 = _temp_1430 OR 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1445 = *_temp_1447  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1444 = _temp_1445 OR 2		(int)
	load	[r14+-20],r1
	mov	2,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1460 = *_temp_1462  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1459 = _temp_1460 OR 1		(int)
	load	[r14+-20],r1
	mov	1,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1475 = *_temp_1477  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1474 = _temp_1475 AND -9		(int)
	load	[r14+-20],r1
	mov	-9,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1490 = *_temp_1492  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1489 = _temp_1490 AND -5		(int)
	load	[r14+-20],r1
	mov	-5,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1505 = *_temp_1507  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1504 = _temp_1505 AND -3		(int)
	load	[r14+-20],r1
	mov	-3,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1520 = *_temp_1522  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1519 = _temp_1520 AND -2		(int)
	load	[r14+-20],r1
	mov	-2,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1532 = _temp_1534		(4 bytes)
	load	[r14+-16],r1
	store	r1,[r14+-24]
!   _temp_1535 = numberOfPages * 4		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	4,r2
	mul	r1,r2,r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1542
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1542
	jmp	_Label_1543
...
! IF STATEMENT...
	mov	1295,r13		! source line 1295
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1546		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1551		(int)
	load	[r14+-40],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1555  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1555 then goto _Label_1554 else goto _Label_1553
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1553
	jmp	_Label_1554
...
! ASSIGNMENT STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-16]
!   if intIsZero (_temp_1559) then goto _runtimeErrorNullPointer
	load	[r14+-16],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=virtPage  sizeInBytes=4
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1558  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   fromAddr = _temp_1558 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-44],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1560:
!   if offset >= 8192 then goto _Label_1562		(int)
	load	[r14+-44],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (fromAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1563 = *fromAddr  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *kernelAddr = _temp_1563  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+12],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1565		(int)
	load	[r14+-36],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1565
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1582
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1582
	jmp	_Label_1583
...
! IF STATEMENT...
	mov	1345,r13		! source line 1345
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1586		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1593		(int)
	load	[r14+-36],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1594  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-11]
!   if _temp_1594 then goto _Label_1592 else goto _Label_1590
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1590
	jmp	_Label_1592
...
!   Retrieve Result: targetName=_temp_1596  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1596 then goto _Label_1591 else goto _Label_1590
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1590
	jmp	_Label_1591
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1598  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   destAddr = _temp_1598 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-40],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1600:
!   if offset >= 8192 then goto _Label_1602		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (kernelAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1603 = *kernelAddr  (sizeInBytes=1)
	load	[r14+16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *destAddr = _temp_1603  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-44],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1605		(int)
	load	[r14+-32],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1605
...
!   Retrieve Result: targetName=_temp_1624  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-40]
!   if _temp_1624 >= 4 then goto _Label_1623		(int)
	load	[r14+-40],r1
	mov	4,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if sourceSize <= maxSize then goto _Label_1628		(int)
	load	[r14+-44],r1
	load	[r14+20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! RETURN STATEMENT...
	...
	mov	1411,r13		! source line 1411
	mov	"\0\0SE",r10
!   _temp_1631 = kernelAddr		(4 bytes)
	load	[r14+12],r1
	store	r1,[r14+-20]
!   _temp_1630 = _temp_1631 + 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_1632 = virtAddr + 4		(int)
	load	[r14+16],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   Prepare Argument: offset=12  value=_temp_1630  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_1632  sizeInBytes=4
	load	[r14+-16],r1
	store	r1,[r15+8]
...
!   Retrieve Result: targetName=_temp_1629  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-28]
!   ReturnResult: _temp_1629  (sizeInBytes=4)
	load	[r14+-28],r1
	store	r1,[r14+8]
	add	r15,56,r15
	pop	r13
