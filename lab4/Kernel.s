...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-136]
!   _temp_995 = _temp_994 + 32
	load	[r14+-136],r1
	add	r1,32,r1
	store	r1,[r14+-132]
!   NEW CLASS Constructor...
!   ZeroMemory: _temp_996 = zeros  (sizeInBytes=92)
	add	r14,-128,r4
	mov	23,r3
_Label_1768:
	store	r0,[r4]
	...
	sub	r3,1,r3
	bne	_Label_1768
!   _temp_996 = _P_Kernel_AddrSpace
	set	_P_Kernel_AddrSpace,r1
	store	r1,[r14+-128]
!   Data Move: *_temp_995 = _temp_996  (sizeInBytes=92)
	add	r14,-128,r5
	load	[r14+-132],r4
	mov	23,r3
_Label_1769:
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1050 = _function_124_PrintObjectAddr
	set	_function_124_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1051 = &freeList
	load	[r14+8],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1077 = _function_124_PrintObjectAddr
	set	_function_124_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1078 = &freeList
	load	[r14+8],r1
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1176:
!   if numberFreeFrames >= 1 then goto _Label_1178		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	mov	1,r2
	cmp	r1,r2
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1182 = f * 8192		(int)
	load	[r14+-28],r1
	mov	8192,r2
	mul	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-12]
!   frameAddr = 1048576 + _temp_1182		(int)
	set	1048576,r1
	load	[r14+-12],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
